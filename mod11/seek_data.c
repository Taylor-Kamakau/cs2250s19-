 ...
 *
 *        Version:  1.0
 *        Created:  03/28/2019 09:16:59 AM
 *       Revision:  none
...
int main(int argc, char* argv[])
{
 FILE *fptr;
   ...
   // fptr = fopen("program.bin", "wb");
    ...
    // Move the cursor to the end of the file. use:
    // fseek(FILE* stream, long int offset, int whence)
    // Different whences in fseek()
    // SEEK_SET: start the offset from the begin of file
    // SEEK_END: start  the offset from the end of the file
    // SEEK_CUR: statts the offset from the current locataion
    // Move the cursor to the end of th file.
